...
Maintenir l’onglet Accueil : recherche globale, ajout rapide de prospects, étudiants accompagnés, filtres, notifications et import rapide des mémoires.

## Fichiers autorisés

- `index.html`
- `accueil.js`
- `js/storage.js` pour les collections communes `students` et `prospects`
...
- Préserver les six liens de `navigation.js` et l’onglet actif Accueil.
